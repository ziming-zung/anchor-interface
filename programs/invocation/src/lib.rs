...
mod invocation {
    ...
    pub fn invoke(ctx: Context<PullStrings>) -> anchor_lang::Result<()> {
        ...
        //             .to_account_info(),
        //     };
        //     msg!("shshshs, {:?}",ctx.remaining_accounts.len());
...
pub struct PullStrings<'info> {
    ...
    /// CHECK: this account is very import.
    /// The function `anchor_lang::solana_program::program::invoke_signed` use this account to sign
